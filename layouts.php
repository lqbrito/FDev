<?php 
	session_start();
	$pag = 4;
	$titulo = "FDev - Upload de scripts de layout PHP e Laravel";
...
<?php
	...
	function upload()
	{
		...
		$diretorio = 'projects' . DIRECTORY_SEPARATOR . $_SESSION['project'] . DIRECTORY_SEPARATOR . 'layouts';
...
<div class="row mb-3">
	...
	<div class="col-md-6">
		<div class="card">
		 	<div class="card-header">
		    	Upload de scripts de layout no projeto <b><?php echo $_SESSION['project']; ?></b>
		 	</div>
