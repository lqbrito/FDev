<?php
	...
	{
		$dirRaiz = 'projects' . DIRECTORY_SEPARATOR . $_SESSION['project'] . DIRECTORY_SEPARATOR . 'namespaces';
	...
	{
		$arquivo = 'projects' . DIRECTORY_SEPARATOR . $_SESSION['project'] . DIRECTORY_SEPARATOR . 'namespaces' . DIRECTORY_SEPARATOR . $_POST['nomenamespace'];
		if (delTree($arquivo))
		{
			echo "<div class='alert alert-info alert-dismissible'>";
	        echo "<button type='button' class='close' data-dismiss='alert' aria-hIDden='true'>×</button>";
	...
	{
		$arquivo = 'projects' . DIRECTORY_SEPARATOR . $_SESSION['project'] . DIRECTORY_SEPARATOR . 'namespaces' . DIRECTORY_SEPARATOR . $_POST['nomenamespace'] . DIRECTORY_SEPARATOR . $_POST['nometabela'];
		if (rmdir($arquivo))
		{
			echo "<div class='alert alert-info alert-dismissible'>";
	        echo "<button type='button' class='close' data-dismiss='alert' aria-hIDden='true'>×</button>";
