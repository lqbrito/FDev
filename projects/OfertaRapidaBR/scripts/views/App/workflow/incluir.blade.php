    ...
    <div class="col-lg-12">
        <div class="card card-warning card-outline">
            ...
            <div class="card-header">
                <h5 class="card-title m-0">Inclusão de novo workflow</h5>
            ...
            <div class="card-body">
                ...
                <form action='{{url("/workflow/incluindo")}}' method="post">
                    ...
                    <div class='row'>
                    	<div class='form-group col-6'>
                    		...
                    		<input type='text' class='form-control' id='descricao' name='descricao' maxlength='70' required='true' autofocus>
                    	</div>
                    </div>
                    <div class='row'>
                    	<div class='form-group col-6'>
                    ...
                    <div class='row'>
                    	<div class='form-group col-6'>
                    		...
                    		<input type='number' class='form-control' id='idempresa' name='idempresa' required='true'>
                    	</div>
                    </div>
