    ...
    <div class="col-lg-12">
        <div class="card card-warning card-outline">
            ...
            <div class="card-header">
                <h5 class="card-title m-0">Consulta de estruturaempresarial</h5>
            ...
            <div class="card-body">
                ...
                <div class="btn-group">
                    <form action='{{url("/estruturaempresarial/alterar")}}' method="post">
                        @csrf
                    ...
                    <form action='{{url("/estruturaempresarial/excluir")}}' method="post">
                        @csrf
                        <input type = "hidden" name = "id" value = "{{$estruturaempresarial->id}}">
                        <button type="submit" class="btn btn-sm btn-primary mr-1"><i class="fas fa-trash"></i> Excluir</button>
                    </form>
                    
                    <a href="{{ url('/estruturaempresarial') }}" class="btn btn-sm btn-primary mr-1"><i class="fas fa-times"></i> Fechar</i></a>
                </div>
