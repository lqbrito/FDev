                ...
                <div class="row">
                    <div class="col-lg-12">
                        <dl class="row">
                            ...
                            <dd class='col-sm-10'>{{$cidades->id}}</dd>
                            <dt class='col-sm-2 text-right'>cidade</dt>
                            <dd class='col-sm-10'>{{$cidades->cidade}}</dd>
                            <dt class='col-sm-2 text-right'>idestado</dt>
                            <dd class='col-sm-10'>{{$cidades->idestado}}</dd>
                            <dt class='col-sm-2 text-right'>created_at</dt>
                            <dd class='col-sm-10'>{{$cidades->created_at}}</dd>
                            <dt class='col-sm-2 text-right'>updated_at</dt>
                            <dd class='col-sm-10'>{{$cidades->updated_at}}</dd>
                        </dl>
                    </div>
                </div>
