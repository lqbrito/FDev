    ...
    <div class="col-lg-12">
        <div class="card card-warning card-outline">
            ...
            <div class="card-header">
                <h5 class="card-title m-0">Listagem de estados</h5>
                <div class="card-tools">
                    <a class="btn btn-tool btn-sm" href="{{url('/estados/incluir')}}"></i>Incluir</a>
                    ...
                    <table class="table table-hover table-sm table-condensed">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <form action='{{url("/estados/consultar")}}' method="post">
                                            @csrf
