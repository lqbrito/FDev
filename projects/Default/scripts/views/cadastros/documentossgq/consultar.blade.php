    ...
    <div class="col-lg-12">
        <div class="card card-warning card-outline">
            ...
            <div class="card-header">
                <h5 class="card-title m-0">Consulta de documentossgq</h5>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <dl class="row">
                            ...
                            <dt class='col-sm-2 text-right'>id_tpdocumentossgq</dt>
                            <dd class='col-sm-10'>{{$tp->id_tpdocumentossgq}}</dd>
                            <dt class='col-sm-2 text-right'>nomedoc</dt>
                            <dd class='col-sm-10'>{{$tp->nomedoc}}</dd>
                            <dt class='col-sm-2 text-right'>localizacao_documentacao</dt>
                            <dd class='col-sm-10'>{{$tp->localizacao_documentacao}}</dd>
                ...
                <div class="btn-group">
                    ...
                    <a href="{{ url('/documentossgq') }}" class="btn btn-sm btn-primary mr-1"><i class="fas fa-times"></i> Fechar</i></a>
                </div>
