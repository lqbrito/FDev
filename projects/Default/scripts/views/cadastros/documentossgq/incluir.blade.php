    ...
    <div class="col-lg-12">
        <div class="card card-warning card-outline">
            ...
            <div class="card-header">
                <h5 class="card-title m-0">Inclusão de novo documentossgq</h5>
            ...
            <div class="card-body">
                ...
                <form action='{{url("/documentossgq/incluindo")}}' method="post">
                    ...
                    <div class='row'>
                    	<div class='form-group col-6'>
                    		...
                    		<input type='number' class='form-control' id='id_tpdocumentossgq' name='id_tpdocumentossgq' required='true'>
                    	</div>
                    </div>
                    <div class='row'>
                    	<div class='form-group col-6'>
                    		<label class='bmd-label-floating' for='nomedoc'>nomedoc</label>
                    		<input type='text' class='form-control' id='nomedoc' name='nomedoc' maxlength='50'>
                    	</div>
                    </div>
                    <div class='row'>
                    	<div class='form-group col-6'>
                    		<label class='bmd-label-floating' for='localizacao_documentacao'>localizacao_documentacao</label>
                    		<input type='text' class='form-control' id='localizacao_documentacao' name='localizacao_documentacao' maxlength='80'>
                    	</div>
                    </div>
