    ...
    <div class="col-lg-12">
        <div class="card card-warning card-outline">
            ...
            <div class="card-header">
                <h5 class="card-title m-0">Listagem de profissionais_designados</h5>
                <div class="card-tools">
                    <a class="btn btn-tool btn-sm" href="{{url('/profissionais_designados/incluir')}}"></i>Incluir</a>
            ...
            <div class="card-body">
                ...
                <form action='{{url("/profissionais_designados/pesquisar")}}' method="post">   
                    <div class="input-group input-group-sm mb-3">
                        @csrf
                        <input type="text" class="form-control" id="textobusca" name="textobusca" placeholder="Procurar no profissionais_designados... (digite pelo menos {{$tamanhoStringBusca}} caracteres)" autofocus value="{{$textobusca}}">                    
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-sm table-condensed">
                        ...
                        <tbody>
                            @foreach($profissionais_designados as $tp)
                            <tr>
                                <td>{{$tp->id}}</td>
                                <td>{{$tp->id_cli}}</td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <form action='{{url("/profissionais_designados/consultar")}}' method="post">
                                            @csrf
                    ...
                    @if (!$listaTudo)
                    {!! $profissionais_designados->links() !!}
                    @endif
