    ...
    <div class="col-lg-12">
        <div class="card card-warning card-outline">
            ...
            <div class="card-header">
                <h5 class="card-title m-0">Listagem de tpusos</h5>
                <div class="card-tools">
                    <a class="btn btn-tool btn-sm" href="{{url('/tpusos/incluir')}}"></i>Incluir</a>
            ...
            <div class="card-body">
                ...
                <form action='{{url("/tpusos/pesquisar")}}' method="post">   
                    <div class="input-group input-group-sm mb-3">
                        @csrf
                        <input type="text" class="form-control" id="textobusca" name="textobusca" placeholder="Procurar no tpusos... (digite pelo menos {{$tamanhoStringBusca}} caracteres)" autofocus value="{{$textobusca}}">                    
                    ...
                    <table class="table table-hover table-sm table-condensed">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <form action='{{url("/tpusos/consultar")}}' method="post">
                                            @csrf
