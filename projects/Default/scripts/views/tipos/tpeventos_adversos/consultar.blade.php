    ...
    <div class="col-lg-12">
        <div class="card card-warning card-outline">
            ...
            <div class="card-header">
                <h5 class="card-title m-0">Consulta de tpeventos_adversos</h5>
            ...
            <div class="card-body">
                ...
                <div class="btn-group">
                    ...
                    <a href="{{ url('/tpeventos_adversos') }}" class="btn btn-sm btn-primary mr-1"><i class="fas fa-times"></i> Fechar</i></a>
                </div>
