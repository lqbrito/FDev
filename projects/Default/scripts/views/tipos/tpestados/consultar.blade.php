    ...
    <div class="col-lg-12">
        <div class="card card-warning card-outline">
            ...
            <div class="card-header">
                <h5 class="card-title m-0">Consulta de tpestados</h5>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <dl class="row">
                            ...
                            <dt class='col-sm-2 text-right'>em_uso</dt>
                            <dd class='col-sm-10'>{{$tp->em_uso}}</dd>
                ...
                <div class="btn-group">
                    ...
                    <a href="{{ url('/tpestados') }}" class="btn btn-sm btn-primary mr-1"><i class="fas fa-times"></i> Fechar</i></a>
                </div>
