    ...
    <div class="col-lg-12">
        <div class="card card-warning card-outline">
            ...
            <div class="card-header">
                <h5 class="card-title m-0">Inclusão de novo tpestados</h5>
            ...
            <div class="card-body">
                ...
                <form action='{{url("/tpestados/incluindo")}}' method="post">
                    ...
                    <div class='row'>
                    	<div class='form-group col-6'>
                    		...
                    		<input type='text' class='form-control' id='em_uso' name='em_uso' maxlength='1' required='true'>
                    	</div>
                    </div>
