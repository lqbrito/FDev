    ...
    <div class="col-lg-12">
        <div class="card card-warning card-outline">
            ...
            <div class="card-header">
                <h5 class="card-title m-0">Listagem de tpaquisicoes</h5>
                <div class="card-tools">
                    <a class="btn btn-tool btn-sm" href="{{url('/tpaquisicoes/incluir')}}"></i>Incluir</a>
            ...
            <div class="card-body">
                ...
                <form action='{{url("/tpaquisicoes/pesquisar")}}' method="post">   
                    <div class="input-group input-group-sm mb-3">
                        @csrf
                        <input type="text" class="form-control" id="textobusca" name="textobusca" placeholder="Procurar no tpaquisicoes... (digite pelo menos {{$tamanhoStringBusca}} caracteres)" autofocus value="{{$textobusca}}">                    
