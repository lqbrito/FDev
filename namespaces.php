<?php 
	session_start();
	$pag = 5;
	$titulo = "FDev - Criação das namespaces do projeto " . $_SESSION['project'];
...
<?php
	...
	if (isset($_POST['criar']))
	{
		try 
		{
			$dir = 'projects' . DIRECTORY_SEPARATOR . $_SESSION['project'] . DIRECTORY_SEPARATOR . 'namespaces' . DIRECTORY_SEPARATOR . $_POST['nomenamespace'];
	...
	{
		$diretorio = 'projects' . DIRECTORY_SEPARATOR . $_SESSION['project'] . DIRECTORY_SEPARATOR . 'namespaces' . DIRECTORY_SEPARATOR . $_POST['namespace'];
		$cont = 0;
	...
	echo "<br>Associe as tabelas do banco de dados às suas namespaces para que os scripts de Controllers e Views sejam gerados nas namespaces corretas.</p>";
